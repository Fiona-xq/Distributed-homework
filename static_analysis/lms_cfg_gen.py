...
parser.add_argument('--mb',dest='mb', default=2, help = 'To set the value of maxbacktrace')
...
with open("/home/fbs2/下载/DisProTrack-main/fbs_ssh_outputs/graph.json","w") as outfile:
...
with open("/home/fbs2/下载/DisProTrack-main/fbs_outputs/time_resource_util.txt","a+") as logfile:
...
with open("/home/fbs2/下载/DisProTrack-main/fbs_outputs/lms_gen_stats.txt","a+") as logfile:
