...
with open('/home/fbs2/下载/DisProTrack-main/fbs_outputs/修改密码/data1.json', 'r') as file:
    datastr = file.read()
#print(type(datastr))
#print(datastr)
# D2=eval(datastr)
...
with open(r"/home/fbs2/下载/DisProTrack-main/fbs_outputs/修改密码//universal_log.json", 'a') as f:
    f.truncate()
