...
def parse_audit_log(fname):
	...
	#uncomment after testing
	#print(j)
        with open('/home/fbs2/下载/DisProTrack-main/fbs_outputs/修改密码/data.json', 'a') as f:
...
if __name__ == '__main__':
    ...
    parse_audit_log("/home/fbs2/下载/DisProTrack-main/fbs_outputs/修改密码/audit_1708507639_merged.json")
    ...
    parse_error_log('/home/fbs2/下载/DisProTrack-main/fbs_outputs/修改密码/LOGS_0311/access_1708507639.log')
    # print('\n\n************Apache access log parsed\n\n')

    parse_error_log('/home/fbs2/下载/DisProTrack-main/fbs_outputs/修改密码/LOGS_0311/error_1708507639.log')
    # print('\n\n************Apache access log parsed\n\n')
    ...
    fin = open("/home/fbs2/下载/DisProTrack-main/fbs_outputs/修改密码/data.json", "rt")
    fout = open("/home/fbs2/下载/DisProTrack-main/fbs_outputs/修改密码/data1.json", "wt")
    ...
    with open("/home/fbs2/下载/DisProTrack-main/fbs_outputs/修改密码/time_resource_util.txt","a+") as logfile:
